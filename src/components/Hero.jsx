...
export default function Hero() {
  ...
  <div
	...
	<h1 className="text-5xl font-bold">David Muendo Musau</h1>
      <p className="mt-4 text-xl">Aspiring Network Engineer | CCNA Student | Cybersecurity Enthusiast</p>
      <a href="#contact" className="mt-6 inline-block bg-blue-600 px-6 py-3 rounded hover:bg-blue-700">
        Contact Me
      </a>        
      </div>
    </div>
